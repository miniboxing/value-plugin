...
object Test {
  def main(args: Array[String]): Unit = {
    ...
    println(identitymono(new Point(1.0)))
    println(identitypoly(new Point(1.0)))
    println(identity2mono(new Point(2.0)))
    println(identity2poly(new Point(2.0)))
    println(identity3mono(new Point(3.0)))
    println(identity3poly(new Point(3.0)))
  }
}
